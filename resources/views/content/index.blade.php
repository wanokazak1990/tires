    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-5" style="padding-top: 30px;">
                <img style="width: 100%; height: auto;" src="{{asset('/assets/images/imgtires2.png')}}">
            </div>
        </div>
    </div>
                    ...
                    <div class="news-slider col-12 d-flex align-items-center">
                        ...
                        <div class="item-block" style="">
                            <div class="">
                                ...
                                <div style="border-radius:5px;width: 100%; height: 200px; background: url('{{Image::url($new->img)}}'); background-size: cover; background-position: center;">
                                </div>
                                <div class="title">
                                    {{$new->title}}
                                </div>
